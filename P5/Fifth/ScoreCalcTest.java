...
class Bachelor extends Person {
    ...
    public String toString() {
        return "Bachelor{" +
                ...
                ", major='" + major + '\'' +
                ", minor='" + minor + '\'' +
                ", scores=" + Arrays.toString(getScores()) +
                ", mean=" + MyMathLib.calcMean(getScores()) +
                ", variation=" + MyMathLib.calcVariation(getScores(), MyMathLib.calcMean(getScores())) +
                ", standard deviation="+MyMathLib.calcStDev(
...
class Master extends Bachelor {
    ...
    public String toString() {
        return "Master{" +
                ...
                ", age='" + getAge() + '\'' +
                ", paper='" + paper + '\'' +
                ", materScores=" + Arrays.toString(scores) +
                ", major='" + getMajor() + '\'' +
                ", minor='" + getMinor() + '\'' +
                ", bachelorScores=" + Arrays.toString(getScores()) +
                ", mean=" + MyMathLib.calcMean(scores) +
                ", variation=" + MyMathLib.calcVariation(scores, MyMathLib.calcMean(scores)) +
                ", standard deviation="+MyMathLib.calcStDev(
                MyMathLib.calcVariation(
...
class MyMathLib {
    ...
    public static float calcStDev(float variation) {
...
이 지저분한 부분을 어떻게 깔끔하게 바꿀 수 있을 지 고민해보도록 하자
 */